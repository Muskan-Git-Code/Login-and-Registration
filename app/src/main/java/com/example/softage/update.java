...
public class update extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(flag==0)     update1(view);
            }
        });
        bt1.setText("Update Account");
    }
    ...
    public void update1(View v) {
        ...
        int a= hp.update(t1, t2, t3, t4);
        if(a>0)
            CookieBar.build(this).setIcon(R.drawable.ic_baseline_star_border_purple500_24).setTitle("Congratulations").setMessage("Your have successfully updated your account information.").setCookiePosition(CookieBar.BOTTOM).setDuration(5000).show();
        else
